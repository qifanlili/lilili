...
</div><?php if(is_array($info_list)){foreach($info_list as $mymps) { ?><div class="hover <? if($mymps['upgrade_type']>1) { ?>ding<?php } ?>">
<span class="ltitle">
<a title="<?=$mymps['title']?>" href="<?=$mymps['uri']?>" target="_blank"  style="<? if($mymps['ifred'] == 1) { ?>color:red;<?php } ?> <? if($mymps['ifbold'] == 1) { ?>font-weight:bold;<?php } ?>"><? echo cutstr($mymps['contact_who'],10); ?>(<? echo cutstr($mymps['title'],16); ?>)</a><? if($mymps['img_count']) { ?><span class="img_count"><?=$mymps['img_count']?>图</span><?php } if($mymps['certify'] == 1) { ?><span class="certify">认证</span><?php } ?>
                        <div class="inforbox">
                            <div class="arrow"> <em></em> <span></span> </div>
                            <div class="tipsbox"> 
                            <a href="<?=$mymps['uri']?>" class="ib-btn">查看详情</a>
                            <h3><?=$mymps['contact_who']?>（<?=$mymps['sex']?>，<? echo str_replace('.00','',$mymps['age']); ?>）</h3>
                            <span class="tip">发布时间：<? echo GetTime($mymps['begintime'],'Y-m-d'); ?></span>
                            <ul class="lists">
                            <li> <span>是否应届：</span> <?=$mymps['graduate']?> </li>
                            <li> <span>区域：</span> <?=$mymps['areaname']?> </li>
                            <li> <span>从业年限：</span>  <? echo str_replace('.00','',$mymps['work_life']); ?></li>
                            <li> <span>最高学历：</span> <?=$mymps['education']?> </li>
                            <li style="width:400px"> <span>求职意向：</span> <?=$mymps['title']?> </li>
                            </ul>
                            
                            <dl class="content noborder">
                            <dt>自我描述：</dt>
                            <dd><? echo cutstr($mymps['content'],'200','...'); ?></dd>
                            </dl>
...
<span class="lterm"><?=$mymps['graduate']?>&nbsp;</span>
<span class="lxb"><?=$mymps['sex']?>&nbsp;</span>
<span class="lage"><? echo str_replace('.00','',$mymps['age']); ?>&nbsp;</span>
<span class="lxueli"><?=$mymps['education']?>&nbsp;</span>
<span class="lexp"><? echo str_replace('.00','',$mymps['work_life']); ?>&nbsp;</span>
</div>
<?php }} ?>
</ul>
</div>
