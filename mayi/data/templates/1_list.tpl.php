...
<div class='typo-smalls'>
                ...
                <?php $i=2; ?>                <?php if(is_array($mymps['extra'])){foreach($mymps['extra'] as $w) { ?>                	<? if($w && $w != '<font class=mayi></font>') { ?><font class="xx<?=$i?>"><? if(in_array($w,array('0元','0.00元','0元/月','0万元','0元/平米','0元/平米/天','0平米'))) { ?>面议<?php } else { echo str_replace('.00','',$w); ?><?php } ?></font><?php } ?>
                <?php $i++; ?>                <?php }} ?>
</div>
</div>
</div>
