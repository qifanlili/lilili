...
<div class="sitemap">
<div class="ul">
        <?php if(is_array($categories)){foreach($categories as $mymps) { ?>            <div class="h3"><a target="_blank" href='<?=$mymps['uri']?>'><?=$city['cityname']?><?=$mymps['catname']?></a></div>
<div class="clearfix"></div>
            <ul>
            <?php if(is_array($mymps['children'])){foreach($mymps['children'] as $w) { ?>            <li><a target="_blank" href='<?=$w['uri']?>' title="<?=$city['cityname']?><?=$w['catname']?>"><?=$city['cityname']?><? echo cutstr($w['catname'],15); ?></a> </li>
            <?php }} ?>
            </ul>
            <?php }} ?>
         </div>
