...
<div class="publish-detail-item">
<input name="markmap" type="button" value="点击标注" class="mappoint" onclick="setbg('地图标注',500,410,'map.php?action=markpoint&width=500&height=310&p=<?=$city['mappoint']?>&cityname=<?=$city['citypy']?>')">
...
<div class="contact">
            ...
            <div class="p-line">
                ...
                <div class="publish-detail-item">
                    <input name="tel" type="text" class="input input-large" value="<?=$post['mobile']?>" datatype="tel" require="true" msg="请填写您的手机号码">
                </div>
            </div>
