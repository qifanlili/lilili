...
<body class="<?=$mymps_global['cfg_tpl_dir']?> bodybg<?=$mymps_global['cfg_tpl_dir']?><?=$mymps_global['bodybg']?>"><div class="mheader">
<div class="mhead">
...
<div class="step2">
<span>1. 选择注册类型<a href="<?=$mymps_global['SiteUrl']?>/<?=$mymps_global['cfg_member_logfile']?>?mod=register">（点此重选）</a></span>
...
<td>
<input name="mobile" id="reg_mobile" type="text" class="input input-large" require="true" datatype="mobile|limit|ajax" url="<?=$mymps_global['SiteUrl']?>/javascript.php?part=chk_remobile" min="4" max="20" msg="请输入您的手机号码">&nbsp;
</td>
</tr>
                    <?php } else { ?>
<tr>
...
<td>
<input name="userid" id="reg_username" type="text" class="input input-large" require="true" datatype="userName|limit|ajax" url="<?=$mymps_global['SiteUrl']?>/javascript.php?part=chk_remember" min="4" max="20" msg="可输入字母、数字、下划线，不得少于4个字符">&nbsp;
</td>
</tr>
<tr>
...
<td><input type="text" name="address" class="input input-large" require="true" datatype="limit" min="1" msg="请填写机构地址"/>
            ...
            <td><input type="text" name="checkcode" datatype="limit|ajax" require="true" class="input" id="checkcode" min="1" msgid="code" msg="请输入下方的图片验证码" url="<?=$mymps_global['SiteUrl']?>/javascript.php?part=chk_authcode"> <span id="code"></span>
            </td>
            </tr>
            <tr>
            <td>&nbsp;</td>
...
<?php } ?>
            ...
            <td>
            <input type="text" name="smscheckcode" datatype="limit|ajax" require="true" class="input input-small" id="smscheckcode" min="1" msg="请输入收到的短信验证码，10分钟内输入有效" msgid="smscode" url="<?=$mymps_global['SiteUrl']?>/javascript.php?part=chk_smsauthcode">
...
<div id="xieyi">
<div class="xieye_nr">
<p>欢迎光临<?=$mymps_global['SiteName']?>！<?=$mymps_global['SiteName']?>致力于为您提供最优质、最便捷的服务。在访问<?=$mymps_global['SiteName']?>的同时，也请您仔细阅读我们的协议条款。您需要同意该条款才能注册成为我们的用户。一经注册，将视为接受并遵守该条款的所有约定。<br /></p>
<p>
