...
function mymps_get_goods_location($catid=0,$str=''){
	...
	$location   = '当前位置：<a href="'.$city['domain'].'">'.$city['cityname'].$GLOBALS['mymps_global']['SiteName'].'</a>'.' <code>'.$raquo.'</code> '.' <a href="'.Rewrite('goods',array('catid'=>0)).'">'.$city[cityname].'商品网购</a>';
