...
<div class="container">
    ...
    <div class="pbody">
        ...
        <input id="ac" name="ac" value="del" type="hidden">
        <div class="datatablewrap">
            ...
            <div class="clearfix datacontrol">
                <div class="dataaction">
                    <span class="minbtn-wrap"><span class="btn"><input type="button" value="删除" class="button" onClick="if(!confirm('您确定要删除这些收藏主题吗?一旦删除将不可恢复'))return false; document.form1.submit();"/></span></span> 
                </div>
