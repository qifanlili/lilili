        ...
        <div class="datatablewrap">
            ...
            <div class="clearfix datacontrol">
                <div class="dataaction">
                    <span class="minbtn-wrap"><span class="btn"><input  type="submit" value="删除" class="button" name="goods_order_submit" onClick="if(!confirm('您确定要删除这些订单记录吗?一旦删除将不可恢复'))return false;"/></span></span> 
                </div>
