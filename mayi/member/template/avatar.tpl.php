                                ...
                                <div class="pbody">
                                    ...
                                    <div class="formgroup section-setting">
                               	    <?php if($face != ''){?>
                                        <div class="formrow">
                                            <h3 class="label">
                                              <label>原<?php echo $if_corp == 1 ? '商铺LOGO' : '头像'; ?>：</label>
                                            </h3>
                                            <div class="form-enter">
                                                <img src="<?php echo $face != '' ? $face : $mymps_global[SiteUrl].'/images/noavatar.gif'?>" border="0" width="180" height="150" />
                                            </div>
                                        </div>
                                        <?php }?>
                                <div class="formrow">
                                            ...
                                            <div class="form-enter">
                                                <input type=file name="mymps_member_logo" size=45 id="litpic">
