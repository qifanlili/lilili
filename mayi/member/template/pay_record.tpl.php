                                    ...
                                    <div class="clearfix topuplogcaption">
                                        ...
                                        <input name="ac" value="record" type="hidden">
                                            <div class="topuplog-inquire-form">
                                            	起始日期
                                                 <input name="begindate" type="text" class="text" value="<?php echo $begindate; ?>" id="datepicker1" />
                                                截止日期
                                                <input name="enddate" type="text" class="text" value="<?php echo $enddate; ?>" id="datepicker2" />
                                            </div>
