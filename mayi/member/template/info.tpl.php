...
<div class="container">
    ...
    <div class="phead"><div class="phead-inner"><div class="phead-inner">
        ...
        <p class="pextra addwebsite"><a href="../<?php echo $mymps_global['cfg_postfile']; ?>" target="_blank"><span>发布分类信息</span></a></p>
    </div></div></div>
    <div class="pbody">
          ...
          <tr>
            <td class="t">
            	<div class="title">
	            	...
	            	<a href="<?=$art['uri']?>" target="_blank" style="float:left;"><?=$art['title']?></a><br> <?php if(mgetcookie('refreshed'.$art['id']) == 1) echo '<span class="refreshed">已刷新</span>'; ?> <?php if($art['ifred'] == 1) echo '<span class="fred">已套红</span>'; ?> <?php if($art['ifbold'] == 1) echo '<span class="fbold">已加粗</span>'; ?>
			...
			<?php }?>
			 ...
			 <a <?php if($art['ifbold'] == 1){?>onClick="alert('该信息的信息标题已被加粗过了，不能重复加粗。');return false;"<?php }else{?> onClick="if(!confirm('您当前拥有金币<?php echo $money_own; ?>个，加粗该信息标题将扣除您<?php echo $mymps_global['cfg_member_info_bold']; ?>个金币'))return false;" <?php }?>href="?m=info&ac=bold&id=<?=$art[id]?>&page=<?=$page?>">加粗</a>
	</span><br />	
	<span class="sticky" >
