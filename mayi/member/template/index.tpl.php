...
<?php $face = strstr($face,'http') ? $face : $mymps_global[SiteUrl].$face;?>
                        ...
                        <div class="content-main-inner">
                            <div class="pwrap accountinfo">
                                <div class="phead"><div class="phead-inner"><div class="phead-inner">
                                    <h3 class="ptitle"><span style="color:red">[<?=$levelname?>]</span> &nbsp;&nbsp;<a style="font-size:14px" href="index.php?m=levelup">升级↑</a></h3>
                                    ...
                                    <div class="clearfix accountinfo-dock">
                                        <div class="account-avatar">
                                            <a href="index.php?t=index&m=avatar" title="更改头像">
                                                <img src="<?php echo $face != '' ? $face : $mymps_global[SiteUrl].'/images/noavatar_small.gif'?>" alt="更改头像" width="48" height="48" />
                                        ...
                                        <div class="account-uesrinfo">
                                            <span class="account-name"><?php echo $row['tname'].' ['.$s_uid.']'; ?> <a target="_blank" style="font-size:12px; font-weight:100;" href="<?php echo $mysite?>">查看我的网站</a> 
                                            <a style="font-size:12px; font-weight:100;" href="index.php?m=shop&ac=template&type=corp"><?php if($if_corp == 1){?>上传banner<?php }?></a> 
                                            
                                            </span>
                                            <span class="account-id">UID: <?php echo $uid; ?></span>
                                        </div>
                                        <div class="account-baseinfo">
                                            <span>Email地址: <?php echo $row['email'] ? $row['email']  : '未填写'; ?></span>
                                            <span>手机号码: <?php echo $row['mobile'] ? $row['mobile']  : '未填写'; ?></span>
                            ...
                            <ul class="clearfix statistics-list">
								<div class="clearfix counttable">
									<div class="cli"><span class="label">分类信息</span> <span class="value"><a href="index.php?m=info"><?=$info_total?>条</a></span> <input name="postinfo" value="发布信息&raquo;" type="button" class="postinfo" onClick="window.open('<?php echo (!$row['tel'] && !$row['qq']) ? '?m=base&error=41' : '../'.$mymps_global['cfg_postfile'].'?cityid='.($cityid?$cityid:$row[cityid]); ?>')"></div>
									...
									<div class="cli"><span class="label">商品</span> <span class="value"><a href="index.php?m=goods&type=corp"><?=$goods_total?>件</a></span><input name="postinfo" value="出售商品&raquo;" type="button" class="postinfo" style="color:#12459c" onClick="location.href='index.php?m=goods&ac=detail&type=corp'"></div>
                            ...
                            <div class="phead"><div class="phead-inner"><div class="phead-inner">
                                <h3 class="ptitle"><span>认证情况</span></h3>
                            </div></div></div>
                            <div class="pbody">
