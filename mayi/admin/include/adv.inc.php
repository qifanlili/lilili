...
$vbm_adv_type[topbanner][notice] = '<li><strong>展现方式：</strong> 顶部横幅广告位于网站顶部，通常使用 1200*60 图片或 Flash 的形式。
...
$vbm_adv_type[headerbanner][notice] = '<li><strong>展现方式：</strong> 页头通栏广告显示于导航栏下方，可使用6张200*72 图片或 Flash 的形式也可使用1张或多张 1000(宽屏1200)*60的横幅图片或flash。
</li><li><strong>价值分析：</strong> 由于能够在页面打开的第一时间将广告内容展现于最醒目的位置，因此成为了网页中价位最高、最适合进行商业宣传或品牌推广的广告类型之一。</li>';

$vbm_adv_type[footerbanner][name] 	= '[系统] 页尾通栏广告';
$vbm_adv_type[footerbanner][notice] = '<li><strong>展现方式：</strong>  页尾通栏广告显示于网站页面中下方，通常使用 1200x60 或其它尺寸图片、Flash 的形式。
...
$vbm_adv_type[intercatad][notice] = '<li><strong>展现方式：</strong> 栏目侧边广告显示于每个信息栏目列表页的侧边，可使用 宽度为220像素的尺寸图片和 Flash 的形式。
...
$vbm_adv_type[indexcatad][notice] = '<li><strong>展现方式：</strong> 分类间广告显示于网站首页相邻的两个根分类之间，可使用 1200*88 或其它尺寸图片和 Flash 的形式。
