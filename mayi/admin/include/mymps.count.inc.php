...
$element[member] = array(
	...
	'商家'=>array(
			'table'=>'member',
			'where'=>'WHERE if_corp = \'1\' AND status = \'1\'',
...
if($mymps_global['cfg_if_corp'] != 1){
	unset($element[plugin]['优惠券'],$element[plugin]['团购'],$element[plugin]['商品'],$element[plugin]['报名'],$element[plugin]['订单'],$element[member]['商家'],$element[certify]['执照']);
}
?>