...
/*$admin_menu[sitesys][group][element]['核心设置']['优化大师']='optimise.php';*/
...
$admin_menu[extend][group][element]['短信设置']['短信接口']='sms.php?part=setting';
$admin_menu[extend][group][element]['短信设置']['短信发送记录']='sms.php?part=sendlist';
