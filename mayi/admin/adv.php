...
else
{
    ...
    else
    {
        ...
        {
            $advnew['parameters'] = addslashes( serialize( array_merge( array(
                "style" => $advnew['style']
            ), array(
                "html" => $advnew['code']
            ), array(
                "position" => $advnew['position']
            ), array(
                "displayorder" => $advnew['displayorder']
            ), $sourcecode ? array(
                "sourcecode" => $sourcecode
            ) : array( ), $advnew['floath'] ? array(
                "floath" => $advnew['floath']
            ) : array( ) ) ) );
        }
        else
        {
