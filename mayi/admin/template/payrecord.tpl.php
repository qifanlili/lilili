...
<table border="0" cellspacing="0" cellpadding="0" class="vbm">
  ...
  <tr bgcolor="#ffffff">
    <td id="menu_tip">
		...
		时间从<input style="width:80px;" id="datepicker1" name="starttime" type="text" class="text" value="<?php echo GetTime($rstarttime,'Y-m-d'); ?>"> - <input id="datepicker2" style="width:80px;" name="endtime" type="text" class="text" value="<?php echo GetTime($rendtime,'Y-m-d'); ?>"> 
...
<table border="0" cellspacing="0" cellpadding="0" class="vbm">
    ...
    <tr bgcolor="white">
        ...
        <td align="left"<?php if($list[paybz] == '等待支付') echo 'style="color:red;"';else echo 'style="color:green;"';?>><?=$list[paybz]?></td>
        <td align="left">
		<?php 
		switch($list[type]){
			case 'alipay':
