...
<tr bgcolor="white">
  <td bgcolor="#F1F5F8">所属模型： <?php if(!$cat['parentid']){?><div style="margin-top:10px; color:#666"><label for="children_mod"><input name="children_mod" value="1" type="checkbox" class="checkbox" id="children_mod">同步应用到子栏目</label></div><?php }?></td>
...
<tr bgcolor="white">
  ...
  <td>
  <input name="usecoin" class="txt" id="usecoin" value="<?php echo $cat['usecoin']; ?>"> <img src="../member/images/mymps_icon_incomes.gif" align="absmiddle"> <font color="red">请填写整数！</font> <font style="color:#777; margin-left:10px;"><br>填写<font color="red">0</font>时，表示联系方式完全公开<br>填写<font color="red">-1</font>时，表示联系方式只对登录的会员公开<br>填写<font color="red">大于0的整数</font>时，表示查看联系方式需扣除会员的相应金币</font>
  </td>
</tr>
</tbody>
</table>
...
<center>
<input type="submit" name="<?php echo CURSCRIPT; ?>_submit" value="保存修改" class="mymps large" />　
