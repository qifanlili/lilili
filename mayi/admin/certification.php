...
if ( !submit_check( CURSCRIPT."_submit" ) )
{
    ...
    else
    {
        ...
        $sql = "SELECT a.*,b.per_certify,b.com_certify,b.tname,b.cname FROM `".$db_mymps."certification` AS a LEFT JOIN `{$db_mymps}member` AS b ON a.userid = b.userid WHERE a.typeid = '{$typeid}' ORDER BY a.id DESC";
